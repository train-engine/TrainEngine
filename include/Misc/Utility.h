...
namespace Utility
{
    ...
    {
        return std::max(static_cast<float>(fillDimensions.x) / initialDimensions.x,
                        static_cast<float>(fillDimensions.y) / initialDimensions.y);
    }
    ...
    {
        return std::min(static_cast<float>(fitDimensions.x) / initialDimensions.x,
                        static_cast<float>(fitDimensions.y) / initialDimensions.y);
    }
